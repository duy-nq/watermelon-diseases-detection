...
class AdvancedFragment : Fragment() {
    ...
    private fun makePrediction(imageUri: Uri, encodedFile: String, callback: PredictionCallback) {
        val uploadURL = "https://detect.roboflow.com/deeper-diseases/8?api_key=LfVTZkyLWVh9dR2GzXjc&confidence=${Setting.confidence*100}&overlap=${Setting.overlap*100}&format=json&stroke=${Setting.stroke}&labels=true"
